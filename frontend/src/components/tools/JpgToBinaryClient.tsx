...
export default function JpgToBinaryClient() {
    ...
    const handleConvert = async () => {
        ...
        try {
            const response = await fetch("/api/jpg-to-binary", {
                method: "POST",
                body: formData,
            });
    ...
    return (
        <ToolPageWrapper
            title="JPG to Binary"
            description="Convert JPG images into Base64-encoded binary text files for safe storage and transfer. The original image can be perfectly restored."
            icon={Shield}
            color="indigo"
        >
