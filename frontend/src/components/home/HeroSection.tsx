        ...
        <section className="text-center space-y-10 relative z-10">
            <div className="relative">
                ...
                <p className="text-base md:text-lg text-gray-600 font-sans leading-relaxed max-w-2xl mx-auto">
                    Your files <span className="font-display text-black bg-[#34D399]/30 px-1 border-b-2 border-black">never leave your device</span>. 100% free, 100% private.
                </p>
                <p className="text-base md:text-lg text-gray-500 font-sans leading-relaxed max-w-2xl mx-auto mt-2">
                    <span className="font-display text-black"> Merge</span>,
                    <span className="font-display text-black"> Split</span>,
                    <span className="font-display text-black"> Compress</span>,
                    <span className="font-display text-black"> Convert</span>,
                    <span className="font-display text-black"> Edit</span>,
                    and <span className="font-display text-black"> Chat</span> with your PDFs — everything runs right in your browser, no uploads, no servers.
                </p>
            </div>
